...
let src = "https://i.imgur.com/tq1CpHn.png";
...
function ajaxPost() {
    ...
    var user = {
        ...
        one: JSON.stringify({
            one: $('input[name=options0]:checked').val(),
            two: $('input[name=options1]:checked').val(),
            three: $('input[name=options2]:checked').val(),
            four: $('input[name=options3]:checked').val()
        })
    }
    console.log("PPPPP4");
    // DO POST
